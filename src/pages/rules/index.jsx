    ...
    <Container className='rules-page'>
      <Row>
        <div className="rules-form">
          <h2 className="title">QUY ĐỊNH THANH TOÁN</h2>
          <h5 className="subtitle">1. QUY ĐỊNH THANH TOÁN</h5>
          <ul className="body">Khách hàng có nhiều hình thức thanh toán khi mua hàng trực tuyến qua website của cửa hàng DANGO.
            <li>Thanh toán trực tuyến: Internet Banking qua cổng thanh toán trực tuyển ở phần thanh toán (phần cuối cùng khi đặt đơn hàng).</li>
            <li>Thanh toán khi nhận hàng (COD). Một số trường hợp nếu khách hàng từng mua hàng thất bại (không nhận hàng khi bên giao hàng tới), chúng tôi sẽ từ chối hình thức COD này, khách hàng được yêu cầu thanh toán trước tiền đơn hàng.</li>
            <li>Thanh toán bằng chuyển khoản qua tài khoản ngân hàng của cửa hàng </li>
          </ul>
